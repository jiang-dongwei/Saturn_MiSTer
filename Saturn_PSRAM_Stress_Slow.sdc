# The slow diagnostic variant uses clk_67 and HALF_DIVIDER=4. PSRAM_CLK
...
# Keep the same conservative board/device delays as the 16.93 MHz project so
# the comparison changes only clock frequency, not the I/O timing model.
